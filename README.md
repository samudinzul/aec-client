...
- **Calibrate for my mic** (under Voice gate, idle or running): starts audio if needed, you speak normally 5 s — sets the speech/silence lines for your mic + engine combo. Stays running after so you can verify the SPEAKING pill. Re-calibrate after switching mic or engine; Reset restores defaults.
