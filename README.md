...
5. **Pick an engine** under Advanced — NKF-AEC is the default; AEC3 is the quality pick, DTLN-AEC adds noise removal. Optionally tick **Noise reduction** on AEC3 or NKF-AEC for WebRTC noise suppression.
